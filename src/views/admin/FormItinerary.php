<!-- app/views/admin/itinerary/FormItinerary.php -->
<div class="card">
    <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="form-label fw-bold">
                                        <i class="fas fa-align-left text-secondary me-1"></i>Mô tả lịch trình
                                    </label>
                                    <textarea 
                                        ...
                                        required><?= htmlspecialchars($day['description']) ?></textarea>
                                    <small class="form-text text-muted">
                                        <i class="fas fa-info-circle"></i> Mô tả các điểm tham quan, hoạt động, bữa ăn...
                                    </small>
                                </div>
                            </div>
                        </div>
